          ...
          <Row>
            <Col md={6}>
              <Card
                ...
                <input type="text" placeholder="username"  value="jay"ref={(input) => {
                    this.username = input
                }} />
                <input type="text" placeholder="phone"  value="Mind72018" ref={(input) => {
                    this.phone = input
                }} />
                ...
                <button onClick={(e) => authentification(e)}>Login</button>
                <br />
